...
public class StudentRepository implements IStudentRepository {
    ...
    static {
        ...
        Student s1 = new Student("Hiếu", LocalDate.parse("2001-01-08"), "hoangngochieuv@gmail.com", "01271245716", currentId++, "C05");
        Student s2 = new Student("Hiếu", LocalDate.parse("2001-01-07"), "hoangngochieuv@gmail.com", "01271245716", currentId++, "C05");
        list.add(s1);
        list.add(s2);
    }
